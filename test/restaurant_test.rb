...
class RestaurantTest < Minitest::Test
  ...
  def test_it_cant_be_open_for_lunch
    restaurant1 = Restaurant.new('10:00', 'Fuel Cafe')
    restaurant2 = Restaurant.new('16:00', 'Il Poggio')
  ...
  def test_it_show_excited_dishes_available
    # skip
    restaurant = Restaurant.new('16:00', 'Il Poggio')
  ...
  def test_restaurant_can_announce_closing_time
    # skip
  ...
  def test_restaurant_can_announce_another_closing_time
    # skip
    restaurant1 = Restaurant.new('10:00', 'Fuel Cafe')
    restaurant2 = Restaurant.new('16:00', 'Il Posto')
